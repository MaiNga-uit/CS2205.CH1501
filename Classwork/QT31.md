...
- Bài toán giải quyết: Các giải pháp video summarization hiện có sử dụng cách tạo shot rất cơ bản, chẳng hạn như cắt shot theo độ dài cố định, điều này có thể phá hủy cấu trúc phân cấp cơ bản của dữ liệu video và làm giảm hơn nữa chất lượng của các bản tóm tắt đã tạo. Mục tiêu bài bảo là để giải quyết vấn đề này. 
- Input: Một Video
